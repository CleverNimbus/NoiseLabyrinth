...
import 'package:noiselabyrinth_gui/persistence/sembast_store.dart';
...
Future<void> main() async {
  ...
  final sembastStore = await SembastStore.create();
  final repo = SembastGenerationConfigRepository(sembastStore.database);

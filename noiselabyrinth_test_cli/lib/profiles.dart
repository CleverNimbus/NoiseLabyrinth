...
class CliProfile {
  ...
  const CliProfile({required this.title, required this.config});
}

const CliProfile pinkNoiseBed = CliProfile(
  ...
  config: GenerationConfig(
    ...
    render: RenderConfig(format: RenderFormat.mp3, durationMinutes: 1),
...
const CliProfile stereoBandlimitedHiss = CliProfile(
  title: 'Stereo bandlimited hiss',
  config: GenerationConfig(
    metadata: MetadataConfig(
...
const CliProfile sineDroneWithDelay = CliProfile(
  title: 'Sine drone with delay',
  config: GenerationConfig(
    metadata: MetadataConfig(
